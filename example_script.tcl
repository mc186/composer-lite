...
set project_name composer-lite-helloworld
set project_path $project_name
set part_sku xck26-sfvc784-2LV-c
set num_threads 64
...
set_property VALUE 512 [ipx::get_bus_parameters WIZ_NUM_REG -of_objects [ipx::get_bus_interfaces S00_AXI -of_objects [ipx::find_open_core user.org:user:axi_lite:1.0]]]
